...
// @license magnet:?xt=urn:btih:5305d91886084f776adcf57509a648432709a7c7&dn=x11.txt
  ...
  return '';
  // On vire l'espace en trop après vjs-control
  var buildcssclass = vjs.Component.prototype.buildCSSClass.call(this);
  return 'vjs-control' + (buildcssclass ? (' ' + buildcssclass) : '');
};
